...
using Xunit;
using static Genocs.QRCodeGenerator.Encoder.PayloadGenerator.BezahlCode;
using static Genocs.QRCodeGenerator.Encoder.PayloadGenerator.SwissQrCode.AdditionalInformation;
using static Genocs.QRCodeGenerator.Encoder.PayloadGenerator.SwissQrCode.Reference;
