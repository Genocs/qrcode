...
public class QRCodeGenerator : IDisposable
{
    ...
    /* Unmerged change from project 'Genocs.QRCodeLibrary (net8.0)'
    Before:
        /// <exception cref="Genocs.QRCodeLibrary.Exceptions.DataTooLongException">Thrown when the payload is too big to be encoded in a QR code.</exception>
    After:
        /// <exception cref="Exceptions.DataTooLongException">Thrown when the payload is too big to be encoded in a QR code.</exception>
    */
    /// <exception cref="QRCodeGenerator.Exceptions.DataTooLongException">Thrown when the payload is too big to be encoded in a QR code.</exception>
    /// <returns>Returns the raw QR code data which can be used for rendering.</returns>
