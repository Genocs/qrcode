...
public class Barcode : IDisposable
{
    ...
    /// <param name="backColor">Background color.</param>
    /// <returns>Image representing the barcode.</returns>
    public static SKImage DoEncode(BarcodeType barcodeType, string data, bool includeLabel, SKColor drawColor, SKColor backColor)
    {
        using var b = new Barcode();
        b.IncludeLabel = includeLabel;
        return b.Encode(barcodeType, data, drawColor, backColor);
    }
    ...
    /// <param name="height">Height of the resulting barcode.(pixels).</param>
    /// <returns>Image representing the barcode.</returns>
    public static SKImage DoEncode(BarcodeType iType, string data, bool includeLabel, SKColor drawColor, SKColor backColor, int width, int height)
    {
        using var b = new Barcode();
        b.IncludeLabel = includeLabel;
    ...
    /// <param name="xml">XML representation of the data and the image of the barcode.</param>
    /// <returns>Image representing the barcode.</returns>
    public static SKImage DoEncode(BarcodeType iType, string data, bool includeLabel, SKColor drawColor, SKColor backColor, int width, int height, out string xml)
    {
        using var b = new Barcode();
        b.IncludeLabel = includeLabel;
